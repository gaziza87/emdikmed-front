...
export const verticalMenuItems = [
    new Menu(1, 'Рабочая область', '/', null, 'dashboard', null, false, 0),
    new Menu(2, 'Администрирование', '/administrator', null, 'group', null, true, 0),
    // new Menu(3, 'Кабинет врача', '/doctor', null, 'meeting_room', null, true, 0),
    new Menu(4, 'Управления заболеваниями', '/dmp', null, 'favorite', null, true, 0),
    // new Menu(5, 'Контент менеджер', '/manager', null, 'ballot', null, true, 0),
    new Menu(6, 'АИС', '/registrant/ais', null, 'calendar_today', null, false, 0),
    // new Menu(7, 'Импорт данных', '/administrator/import', null, 'archive', null, false, 0),

    new Menu(6, 'Организации', '/administrator/organization', null, 'view_list', null, false, 2),
    new Menu(7, 'Сотрудники', '/administrator/staff', null, 'supervisor_account', null, false, 2),
    new Menu(8, 'Пользователи', '/administrator/users', null, 'person', null, false, 2),
    // new Menu(9, 'Отчеты', '/administrator/reports', null, 'description', null, false, 2),
    // new Menu(10, 'Контент', '/manager', null, 'schedule', null, false, 5),
    // new Menu(11, 'Видео', '/manager/video', null, 'video_library', null, false, 5),
    new Menu(12, 'Конфигурирование ПУЗ', '/dmp', null, 'person', null, false, 4),
    // new Menu(13, 'Пациенты ПУЗ', '/dmp/patients', null, 'dashboard', null, false, 4),
];
